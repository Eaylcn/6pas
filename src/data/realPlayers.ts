...
const squads: Record<string, Row[]> = {
  ...
  // ---- Havuz genişletmesi (v0.10): 8 yeni kulüp ----
  'lon-blues': [
    ['Robert Sánchez', 'GK', 82, 'İspanya'],
    ['Reece James', 'DEF', 84, 'İngiltere'],
    ['Marc Cucurella', 'DEF', 84, 'İspanya'],
    ['Levi Colwill', 'DEF', 82, 'İngiltere'],
    ['Trevoh Chalobah', 'DEF', 81, 'İngiltere'],
    ['Moisés Caicedo', 'MID', 87, 'Ekvador'],
    ['Enzo Fernández', 'MID', 86, 'Arjantin'],
    ['Cole Palmer', 'MID', 89, 'İngiltere'],
    ['João Pedro', 'ATK', 84, 'Brezilya'],
    ['Estêvão', 'ATK', 84, 'Brezilya'],
    ['Alejandro Garnacho', 'ATK', 83, 'Arjantin'],
    ['Pedro Neto', 'ATK', 82, 'Portekiz'],
  ],
  'man-reds': [
    ['Senne Lammens', 'GK', 80, 'Belçika'],
    ['Matthijs de Ligt', 'DEF', 84, 'Hollanda'],
    ['Leny Yoro', 'DEF', 81, 'Fransa'],
    ['Diogo Dalot', 'DEF', 81, 'Portekiz'],
    ['Luke Shaw', 'DEF', 80, 'İngiltere'],
    ['Bruno Fernandes', 'MID', 88, 'Portekiz'],
    ['Casemiro', 'MID', 84, 'Brezilya'],
    ['Manuel Ugarte', 'MID', 82, 'Uruguay'],
    ['Bryan Mbeumo', 'ATK', 85, 'Kamerun'],
    ['Matheus Cunha', 'ATK', 85, 'Brezilya'],
    ['Benjamin Šeško', 'ATK', 84, 'Slovenya'],
    ['Amad Diallo', 'ATK', 84, 'Fildişi Sahili'],
  ],
  'mil-serpenti': [
    ['Yann Sommer', 'GK', 85, 'İsviçre'],
    ['Alessandro Bastoni', 'DEF', 87, 'İtalya'],
    ['Denzel Dumfries', 'DEF', 84, 'Hollanda'],
    ['Federico Dimarco', 'DEF', 85, 'İtalya'],
    ['Francesco Acerbi', 'DEF', 81, 'İtalya'],
    ['Nicolò Barella', 'MID', 87, 'İtalya'],
    ['Hakan Çalhanoğlu', 'MID', 86, 'Türkiye'],
    ['Henrikh Mkhitaryan', 'MID', 81, 'Ermenistan'],
    ['Petar Sučić', 'MID', 80, 'Hırvatistan'],
    ['Lautaro Martínez', 'ATK', 89, 'Arjantin'],
    ['Marcus Thuram', 'ATK', 86, 'Fransa'],
    ['Ange-Yoan Bonny', 'ATK', 79, 'Fransa'],
  ],
  'nap-vulcano': [
    ['Alex Meret', 'GK', 83, 'İtalya'],
    ['Giovanni Di Lorenzo', 'DEF', 84, 'İtalya'],
    ['Alessandro Buongiorno', 'DEF', 84, 'İtalya'],
    ['Amir Rrahmani', 'DEF', 82, 'Kosova'],
    ['Mathías Olivera', 'DEF', 81, 'Uruguay'],
    ['Kevin De Bruyne', 'MID', 88, 'Belçika'],
    ['Scott McTominay', 'MID', 86, 'İskoçya'],
    ['Stanislav Lobotka', 'MID', 85, 'Slovakya'],
    ['André-Frank Zambo Anguissa', 'MID', 84, 'Kamerun'],
    ['Romelu Lukaku', 'ATK', 84, 'Belçika'],
    ['Rasmus Højlund', 'ATK', 82, 'Danimarka'],
    ['Matteo Politano', 'ATK', 83, 'İtalya'],
  ],
  'lev-fabrik': [
    ['Mark Flekken', 'GK', 82, 'Hollanda'],
    ['Alejandro Grimaldo', 'DEF', 86, 'İspanya'],
    ['Edmond Tapsoba', 'DEF', 83, 'Burkina Faso'],
    ['Jarell Quansah', 'DEF', 80, 'İngiltere'],
    ['Robert Andrich', 'MID', 82, 'Almanya'],
    ['Aleix García', 'MID', 82, 'İspanya'],
    ['Ibrahim Maza', 'MID', 79, 'Cezayir'],
    ['Jonas Hofmann', 'MID', 78, 'Almanya'],
    ['Patrik Schick', 'ATK', 84, 'Çekya'],
    ['Nathan Tella', 'ATK', 80, 'Nijerya'],
    ['Ernest Poku', 'ATK', 78, 'Hollanda'],
  ],
  'mar-azur': [
    ['Gerónimo Rulli', 'GK', 83, 'Arjantin'],
    ['Benjamin Pavard', 'DEF', 84, 'Fransa'],
    ['Leonardo Balerdi', 'DEF', 83, 'Arjantin'],
    ['Facundo Medina', 'DEF', 80, 'Arjantin'],
    ['Timothy Weah', 'DEF', 80, 'ABD'],
    ['Pierre-Emile Højbjerg', 'MID', 83, 'Danimarka'],
    ['Matt O’Riley', 'MID', 80, 'Danimarka'],
    ['Geoffrey Kondogbia', 'MID', 79, 'Orta Afrika'],
    ['Mason Greenwood', 'ATK', 86, 'İngiltere'],
    ['Igor Paixão', 'ATK', 82, 'Brezilya'],
    ['Pierre-Emerick Aubameyang', 'ATK', 82, 'Gabon'],
    ['Amine Gouiri', 'ATK', 81, 'Cezayir'],
  ],
  'lis-leao': [
    ['Rui Silva', 'GK', 82, 'Portekiz'],
    ['Gonçalo Inácio', 'DEF', 84, 'Portekiz'],
    ['Ousmane Diomande', 'DEF', 82, 'Fildişi Sahili'],
    ['Iván Fresneda', 'DEF', 79, 'İspanya'],
    ['Morten Hjulmand', 'MID', 84, 'Danimarka'],
    ['Pedro Gonçalves', 'MID', 85, 'Portekiz'],
    ['João Simões', 'MID', 78, 'Portekiz'],
    ['Francisco Trincão', 'ATK', 83, 'Portekiz'],
    ['Geovany Quenda', 'ATK', 82, 'Portekiz'],
    ['Fotis Ioannidis', 'ATK', 82, 'Yunanistan'],
    ['Luis Suárez', 'ATK', 82, 'Kolombiya'],
  ],
  'trb-bordo': [
    ['André Onana', 'GK', 85, 'Kamerun'],
    ['Stefan Savić', 'DEF', 80, 'Karadağ'],
    ['Arseniy Batagov', 'DEF', 78, 'Ukrayna'],
    ['Serdar Saatçı', 'DEF', 77, 'Türkiye'],
    ['Okay Yokuşlu', 'MID', 79, 'Türkiye'],
    ['Ozan Tufan', 'MID', 78, 'Türkiye'],
    ['Tim Jabol-Folcarelli', 'MID', 78, 'Fransa'],
    ['Christ Inao Oulai', 'MID', 77, 'Fildişi Sahili'],
    ['Paul Onuachu', 'ATK', 83, 'Nijerya'],
    ['Felipe Augusto', 'ATK', 80, 'Brezilya'],
    ['Oleksandr Zubkov', 'ATK', 79, 'Ukrayna'],
    ['Ernest Muçi', 'ATK', 79, 'Arnavutluk'],
  ],
};
...
const signaturePerks: Record<string, string[]> = {
  ...
  // v0.10 genişletmesi
  'Cole Palmer': ['acimasiz-plase', 'dar-alan-ustasi'],
  'Kevin De Bruyne': ['kilit-pas', 'onsezi-pasi'],
  'Bruno Fernandes': ['son-vurus', 'kilit-pas'],
  'Lautaro Martínez': ['acimasiz-plase', 'ilk-temas'],
  'Hakan Çalhanoğlu': ['olu-kose', 'pas-muhendisi'],
  'Mason Greenwood': ['bilek-kiran', 'dar-aci-ustasi'],
  'Scott McTominay': ['ikinci-top-avcisi', 'hava-fisegi'],
  'Moisés Caicedo': ['pres-kiran', 'ikinci-top-avcisi'],
  'Alessandro Bastoni': ['sessiz-mudahale', 'alan-kilidi'],
  'André Onana': ['ucan-eldiven', 'panik-yok'],
  'Paul Onuachu': ['hava-fisegi', 'kor-nokta-kosusu'],
};
...
const leagueOfClub: Record<string, string> = {
  ...
  'par-etoile': 'fsl', 'lyo-lumiere': 'fsl', 'mar-azur': 'fsl',
  'mun-adler': 'gpl', 'dor-vale': 'gpl', 'lev-fabrik': 'gpl',
